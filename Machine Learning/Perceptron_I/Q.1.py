...
# This function represents a perceptron with X as Input space, y as labels. lr is the learning rate. iteration_list=Number of iterations.m,n are dimension of X.
